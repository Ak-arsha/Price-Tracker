...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-ci-default-key-change-in-production')
...
SCRAPE_TRIGGER_SECRET = os.environ.get('SCRAPE_TRIGGER_SECRET', '')
